...
<head>
    <meta charset="UTF-8">
    <title>Manage News - Head Dashboard</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        ...
        <span class="navbar-brand ms-3">Head Dashboard - Manage News</span>
        <div class="d-flex">
        ...
        <div class="list-group">
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="list-group-item list-group-item-action flex-column align-items-start mb-2">
                    ...
                    <!-- Removed created_by display as column does not exist -->
                    <div class="mt-2">
                        <a href="announcements.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary me-2">Edit</a>
                        <a href="announcements.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this news?');">Delete</a>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
